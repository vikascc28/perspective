...
class LocalPerspective(object):
    def __init__(self, loop: Optional[AbstractEventLoop] = None):
      ...
      self._session = self._server.new_session(lambda *args, **kwargs: self._handle_new_session(*args, **kwargs))
      self._client = PySyncClient(lambda *args, **kwargs: self._handle_sync_client(*args, **kwargs))
      self._loop = loop
