 ...
 */
export class PerspectiveJupyterWidget extends Widget {
    constructor(name = "Perspective", options) {
        ...
        // Create the <perspective-viewer> HTML element
        this._viewer = PerspectiveJupyterWidget.createViewer(this.node);
