...
#define UNARY_STD_INT_FUNCTION_BODY(FUNC)                                      \
    ...
    return rval;
            ...
            inline bool
            is_nan_impl(const t_type_check_result& v, t_type_check_result_type_tag) {
                return v.is_numeric();
            }
            ...
            template <>
            inline int
            to_int32_impl(const t_type_check_result& v, t_type_check_result_type_tag) {
                if (!v.is_valid())
                    return std::numeric_limits<int>::quiet_NaN();
                switch (v.get_dtype()) {
                    // case perspective::t_dtype::DTYPE_INT64:
            ...
            template <>
            inline long long int
            to_int64_impl(const t_type_check_result& v, t_type_check_result_type_tag) {
                if (!v.is_valid())
                    return std::numeric_limits<long long int>::quiet_NaN();
                switch (v.get_dtype()) {
                    // case perspective::t_dtype::DTYPE_INT64:
            ...
            abs_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(abs)
            }
            template <>
            inline t_type_check_result
            acos_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(acos)
            }
            template <>
            inline t_type_check_result
            acosh_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(acosh)
            }
            template <>
            inline t_type_check_result
            asin_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(asin)
            }
            template <>
            inline t_type_check_result
            asinh_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(asinh)
            }
            template <>
            inline t_type_check_result
            atan_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(atan)
            }
            template <>
            inline t_type_check_result
            atanh_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(atanh)
            }
            template <>
            inline t_type_check_result
            ceil_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(ceil)
            }
            template <>
            inline t_type_check_result
            cos_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(cos)
            }
            template <>
            inline t_type_check_result
            cosh_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(cosh)
            }
            template <>
            inline t_type_check_result
            exp_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(exp)
            }
            template <>
            inline t_type_check_result
            expm1_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(expm1)
            }
            template <>
            inline t_type_check_result
            floor_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(floor)
            }
            template <>
            inline t_type_check_result
            log_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(log)
            }
            template <>
            inline t_type_check_result
            log10_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(log10)
            }
            template <>
            inline t_type_check_result
            log2_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(log2)
            }
            template <>
            inline t_type_check_result
            log1p_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(log1p)
            }
            template <>
            inline t_type_check_result
            round_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(round)
            }

            template <>
            inline t_type_check_result
            neg_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(neg)
            }
            template <>
            inline t_type_check_result
            pos_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(pos)
            }

            template <>
            inline t_type_check_result
            sgn_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(sgn)
            }

            template <>
            inline t_type_check_result
            sin_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(sin)
            }

            template <>
            inline t_type_check_result
            sinc_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(sinc)
            }
            template <>
            inline t_type_check_result
            sinh_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(sinh)
            }
            template <>
            inline t_type_check_result
            sqrt_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(sqrt)
            }
            template <>
            inline t_type_check_result
            tan_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(tan)
            }
            template <>
            inline t_type_check_result
            tanh_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(tanh)
            }

            template <>
            inline t_type_check_result
            cot_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(cot)
            }

            template <>
            inline t_type_check_result
            sec_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(sec)
            }
            template <>
            inline t_type_check_result
            csc_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(csc)
            }

            template <>
            inline t_type_check_result
            r2d_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(r2d)
            }

            template <>
            inline t_type_check_result
            d2r_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(d2r)
            }

            template <>
            inline t_type_check_result
            d2g_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(d2g)
            }

            template <>
            inline t_type_check_result
            g2d_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(g2d)
            }
            template <>
            inline t_type_check_result
            notl_impl(const t_type_check_result v, t_type_check_result_type_tag) {
               UNARY_STD_TYPE_CHECK_FUNCTION_BODY(notl)
            }

            template <>
            inline t_type_check_result
            frac_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(frac)
            }

            template <>
            inline t_type_check_result
            trunc_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(trunc)
            }

            template <>
            inline t_type_check_result
            erf_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(erf)
            }
            template <>
            inline t_type_check_result
            erfc_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(erfc)
            }
            template <>
            inline t_type_check_result
            ncdf_impl(const t_type_check_result v, t_type_check_result_type_tag) {
                UNARY_STD_TYPE_CHECK_FUNCTION_BODY(ncdf)
            }
            ...
            inline t_type_check_result
            min_impl(
                const t_type_check_result v0, const t_type_check_result v1, t_type_check_result_type_tag) {
                t_type_check_result rval;
                return rval;
            }
            ...
            template <>
            inline bool
            is_integer_impl(const t_type_check_result& v, t_type_check_result_type_tag) {
                switch (v.m_type) {
                    case perspective::t_dtype::DTYPE_INT64:
                    case perspective::t_dtype::DTYPE_INT32:
                    case perspective::t_dtype::DTYPE_INT16:
...
#undef UNARY_STD_TYPE_CHECK_FUNCTION_BODY
            ...
            process_impl(const operator_type operation,
                ...
                switch (operation) {
                    ...
                    case e_pow:
                        return pow_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_atan2:
                        return atan2_impl<t_type_check_result>(
                            arg0, arg1, type_check_result_type_tag);
                    case e_min:
                        return min_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_max:
                        return max_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_logn:
                    ...
                    case e_and:
                        return and_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_nand:
                        return nand_impl<t_type_check_result>(
                            arg0, arg1, type_check_result_type_tag);
                    case e_or:
                        return or_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_nor:
                        return nor_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_xor:
                        return xor_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_xnor:
                    ...
                    case e_roundn:
                        return roundn_impl<t_type_check_result>(
                            arg0, arg1, type_check_result_type_tag);
                    case e_equal:
                        return equal_impl(arg0, arg1, type_check_result_type_tag);
                    case e_nequal:
                        return nequal_impl(arg0, arg1, type_check_result_type_tag);
                    case e_hypot:
                        return hypot_impl<t_type_check_result>(
                            arg0, arg1, type_check_result_type_tag);
                    case e_shr:
                        return shr_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    case e_shl:
                        return shl_impl<t_type_check_result>(arg0, arg1, type_check_result_type_tag);
                    default: {
                        return rval;
                    }
                }
    ...
    template <>
    struct lt_op<t_type_check_result> : public opr_base<t_type_check_result> {
        ...
        static inline typename expression_node<t_type_check_result>::node_type
        type() {
    ...
    template <>
    struct lte_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct gt_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct gte_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct eq_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
        static inline t_type_check_result
        process(Type t1, Type t2) {
            t_type_check_result rval;
    ...
    template <>
    struct equal_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct ne_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct and_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct nand_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct or_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct nor_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct xor_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct xnor_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
     ...
     */
    template <>
    struct in_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;

        static inline t_type_check_result
        process(const t_type_check_result&, const t_type_check_result&) {
            t_type_check_result rval;
            return rval;
        }
        static inline t_type_check_result
    ...
    template <>
    struct like_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct ilike_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;
    ...
    template <>
    struct inrange_op<t_type_check_result> : public opr_base<t_type_check_result> {
        typedef typename opr_base<t_type_check_result>::Type Type;

        static inline t_type_check_result
        process(const t_type_check_result& t0, const t_type_check_result& t1, const t_type_check_result& t2) {
            t_type_check_result rval;
            return rval;
        }
    ...
    inline bool
    is_true(const expression_node<t_type_check_result>* node) {
        return true;
    }

    template <>
    inline bool
    is_true(const std::pair<expression_node<t_type_check_result>*, bool>& node) {
        return true;
    }

    template <>
    inline bool
    is_false(const expression_node<t_type_check_result>* node) {
        return true;
    }

    template <>
    inline bool
    is_false(const std::pair<expression_node<t_type_check_result>*, bool>& node) {
        return true;
    }
    ...
    inline bool
    is_true(const t_type_check_result& v) {
        return true;
    }

    inline bool
    is_false(const t_type_check_result& v) {
        return true;
    };
    /******************************************************************************
     *
    ...
    template <typename Iterator>
    inline bool
    string_to_real(Iterator& itr_external, const Iterator end,
        t_type_check_result& t, numeric::details::t_type_check_result_type_tag) {
        double x = 1;

        bool parsed = string_to_real(itr_external, end, x,
            numeric::details::real_type_tag());
