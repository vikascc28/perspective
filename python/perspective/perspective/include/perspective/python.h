...
static PyMethodDef libpsppy_methods[] = {
   ...
   * Perspective defs
   */
  {"str_to_filter_op", (PyCFunction)str_to_filter_op, METH_VARARGS},
  {"make_table", (PyCFunction)make_table_py, METH_VARARGS},
  {"update_table", (PyCFunction)update_table_py, METH_VARARGS},
  {"make_view_unit", (PyCFunction)make_view_unit, METH_VARARGS},
  {"make_view_zero", (PyCFunction)make_view_ctx0, METH_VARARGS},
  {"make_view_one", (PyCFunction)make_view_ctx1, METH_VARARGS},
  {"make_view_two", (PyCFunction)make_view_ctx2, METH_VARARGS},
  {"get_data_slice_unit", (PyCFunction)get_data_slice_unit, METH_VARARGS},
  {"get_from_data_slice_unit", (PyCFunction)get_from_data_slice_unit, METH_VARARGS},
  {"get_pkeys_from_data_slice_unit", (PyCFunction)get_pkeys_from_data_slice_unit, METH_VARARGS},
  {"get_data_slice_zero", (PyCFunction)get_data_slice_ctx0, METH_VARARGS},
  {"get_from_data_slice_zero", (PyCFunction)get_from_data_slice_ctx0, METH_VARARGS},
  {"get_pkeys_from_data_slice_zero", (PyCFunction)get_pkeys_from_data_slice_ctx0, METH_VARARGS},
  {"get_data_slice_one", (PyCFunction)get_data_slice_ctx1, METH_VARARGS},
  {"get_from_data_slice_one", (PyCFunction)get_from_data_slice_ctx1, METH_VARARGS},
  {"get_pkeys_from_data_slice_one", (PyCFunction)get_pkeys_from_data_slice_ctx1, METH_VARARGS},
  {"get_data_slice_two", (PyCFunction)get_data_slice_ctx2, METH_VARARGS},
  {"get_from_data_slice_two", (PyCFunction)get_from_data_slice_ctx2, METH_VARARGS},
  {"get_pkeys_from_data_slice_two", (PyCFunction)get_pkeys_from_data_slice_ctx2, METH_VARARGS},
  {"to_arrow_unit", (PyCFunction)to_arrow_unit, METH_VARARGS},
  {"to_arrow_zero", (PyCFunction)to_arrow_zero, METH_VARARGS},
  {"to_arrow_one", (PyCFunction)to_arrow_one, METH_VARARGS},
  {"to_arrow_two", (PyCFunction)to_arrow_two, METH_VARARGS},
  {"to_csv_unit", (PyCFunction)to_csv_unit, METH_VARARGS},
  {"to_csv_zero", (PyCFunction)to_csv_zero, METH_VARARGS},
  {"to_csv_one", (PyCFunction)to_csv_one, METH_VARARGS},
  {"to_csv_two", (PyCFunction)to_csv_two, METH_VARARGS},
  {"get_row_delta_unit", (PyCFunction)get_row_delta_unit, METH_VARARGS},
  {"get_row_delta_zero", (PyCFunction)get_row_delta_zero, METH_VARARGS},
  {"get_row_delta_one", (PyCFunction)get_row_delta_one, METH_VARARGS},
  {"get_row_delta_two", (PyCFunction)get_row_delta_two, METH_VARARGS},
  {"validate_expressions", (PyCFunction)validate_expressions_py, METH_VARARGS},
  {"init_expression_parser", (PyCFunction)init_expression_parser, METH_VARARGS},
  {"scalar_to_py", (PyCFunction)scalar_to_py, METH_VARARGS},
